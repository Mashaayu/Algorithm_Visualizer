	...
	return (
		<div>
			<div className='sideNavbar'>
				...
				<div>
					<br />
					<a href="https://github.com/Mashaayu" target='_blank' rel='noreferrer' >
						<img style={{ width: '90px' }} src={process.env.PUBLIC_URL + "https://cdn-icons-png.flaticon.com/512/25/25231.png"} alt='myGithub' />
					</a>
				</div>
			</div>
